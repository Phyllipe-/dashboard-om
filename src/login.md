...
const card = html`<div class="login-page">
  <div class="login-card">
    <h2><strong>MOVA</strong> <span style="font-weight:400;font-size:0.75rem;color:var(--theme-foreground-muted);">| Mobility Orientation Visualization Analytics</span></h2>
